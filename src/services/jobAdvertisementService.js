...
export default class JobAdvertisementService{
  ...
  getByCompanyId(id){
    return axios.get(`http://127.0.0.1:8081/api/jobadvertisement/getByCompanyId/21?pageNo=1&pageSize=10`)
  }



  getAllCreatedDate(){
    return axios.get("http://127.0.0.1:8081/api/jobadvertisement/getAllCreatedDate")
  }
